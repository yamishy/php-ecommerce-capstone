...
if (!empty($_POST)) {
    ...
    if (empty($errors)) {
        ...
        try {
            ...
            $mail->Username = 'project@gmail.com'; // YOUR gmail email
            $mail->Password = 'project2022'; // YOUR gmail password

            // Sender and recipient settings
            $mail->setFrom('project@gmail.com', 'Website Support');
            $mail->addAddress($email, $name);
            $mail->addReplyTo('project@gmail.com', 'Website Support'); // to set the reply to

            // Setting the email content
            $mail->IsHTML(true);
            $mail->Subject = "Website Inquiry Confirmation";
                ...
                <div class="panel-left">
                    ...
                    <div class="contact-form">
                        ...
                        <form method="POST" action="" accept-charset="UTF-8"><input name="_token" type="hidden" value="">
                            ...
                            <button name="login" type="submit" class="contact-form-field submit-btn button v-project-blue margin-t25">Submit</button>
                        </form>
                    </div>
                </div>
            </div>
